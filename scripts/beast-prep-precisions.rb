...
<beast>
	...
	<taxon id="mostRecentDate">
		<date value="2012.0" direction="forwards" units="years"/>
	</taxon>
...
# MCMC
print <<EOF
	<mcmc id="mcmc" chainLength="100000000" autoOptimize="true" operatorAnalysis="#{analysis}.ops">
		...
		<log id="fileLog" logEvery="50000" fileName="#{analysis}.log" overwrite="false">
			<posterior idref="posterior"/>
			<prior idref="prior"/>
			<likelihood idref="likelihood"/>
			<parameter idref="treeModel.rootHeight"/>
		...
		<log id="tipDateLog" logEvery="50000" fileName="#{analysis}.tipDates" overwrite="false">		
EOF
...
print <<EOF
		...
		<logTree id="treeFileLog" logEvery="50000" nexusFormat="true" fileName="#{analysis}.trees" sortTranslationTable="true">
			<treeModel idref="treeModel"/>
			<posterior idref="posterior"/>
		</logTree>
	</mcmc>		
